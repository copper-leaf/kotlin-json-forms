...
public actual fun UiElement.Control.Companion.materialDefaults(): List<Registered<UiElement.Control, ControlRenderer>> =
    listOf(
        // text fields
...
public actual fun UiElement.Companion.materialDefaults(): List<Registered<UiElement.ElementWithChildren, UiElementRenderer>> =
    listOf(
