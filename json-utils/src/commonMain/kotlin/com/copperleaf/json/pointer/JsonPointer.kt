    ...
    public companion object {
        public fun parse(pointer: String): JsonPointer {
            ...
            check(!tokens.contains("[]")) {
                "JsonPointer cannot contain any array-index placeholders. Use AbstractJsonPointer to represent a " +
                    "pointer that must be reified at runtime with proper array indices."
            }
